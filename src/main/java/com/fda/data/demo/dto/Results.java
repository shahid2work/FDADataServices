...
public class Results {
    ...
    public Results withSkip(Integer skip) {
        this.skip = skip;
        return this;
    }
    ...
    public Results withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((this.limit == rhs.limit)||((this.limit!= null)&&this.limit.equals(rhs.limit)))&&((this.skip == rhs.skip)||((this.skip!= null)&&this.skip.equals(rhs.skip))))&&((this.total == rhs.total)||((this.total!= null)&&this.total.equals(rhs.total))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
